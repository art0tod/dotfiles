...
lsp.on_attach(function(client, bufnf)
	local opts = {buffer = bufnr, remap = false}

	vim.keymap.set('n', 'gd', function() vim.lsp.buf.defenition() end, opts)
	vim.keymap.set('n', 'K', function() vim.lsp.buf.hover() end, opts)
	vim.keymap.set('n', '<leader>vws', function() vim.lsp.buf.defenition() end, opts)
	...
	vim.keymap.set('i', '<C-h>vca', function() vim.lsp.signature_help() end, opts)
end)
